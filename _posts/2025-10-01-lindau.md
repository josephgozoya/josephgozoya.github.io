...
<div class="slider-container-horizontal">
  <div class="slider-track-horizontal">
    <div class="slide-item-horizontal" style="background-image: url('/assets/images/lindau1.jpg');"></div>
    <div class="slide-item-horizontal" style="background-image: url('/assets/images/lindau2.jpg');"></div>
    <div class="slide-item-horizontal" style="background-image: url('/assets/images/image.jpg');"></div>
  </div>
</div>

<style>
.slider-container-horizontal { width: 100%; height: 450px; overflow: hidden; position: relative; border-radius: 8px; margin-bottom: 30px; }
.slider-track-horizontal { display: flex; width: 300%; height: 100%; animation: slide-move 15s infinite ease-in-out; }
.slide-item-horizontal { width: 33.333%; height: 100%; background-size: cover; background-position: center; }
